const CACHE='bs-ofis-butce-ui221-debt-balance-20260813';
const ASSETS=[
  './?v=221',
  './index.html?v=221',
  './styles.css?v=219',
  './app.js?v=176',
  './core-compat.js?v=221',
  './v17-ui.js?v=218',
  './v175-ui.js?v=175',
  './v176-ui.js?v=218',
  './v177-ui.js?v=214',
    ...
    fetch(e.request,{cache:'no-store'})
      ...
      .catch(() =>
        caches.match(e.request)
          .then(r=>r||caches.match('./?v=221')||caches.match('./index.html?v=221'))
      )
  );
});
